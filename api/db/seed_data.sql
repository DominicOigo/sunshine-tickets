...
insert into ticket_tiers (id, event_id, name, description, price, capacity, sold, sort_order, is_active) values
  ...
  ('a1a11111-1111-1111-1111-111111111111', 'e1a11111-1111-1111-1111-111111111111', 'Regular Pass', 'Access to all keynotes and expo hall', 3000, 500, 320, 0, true),
  ('a1b22222-2222-2222-2222-222222222222', 'e1a11111-1111-1111-1111-111111111111', 'VIP Pass', 'Front row seating, VIP lounge access & lunch', 10000, 100, 65, 1, true),

  -- Tiers for Sol Fest
  ('a2a11111-1111-1111-1111-111111111111', 'e2b22222-2222-2222-2222-222222222222', 'Regular Arena', 'General admission to the main arena', 2500, 2000, 1850, 0, true),
  ('a2b22222-2222-2222-2222-222222222222', 'e2b22222-2222-2222-2222-222222222222', 'VIP Golden Circle', 'Closest access to the stage and private bar', 8000, 500, 420, 1, true),

  -- Tiers for Blankets & Wine
  ('a3a11111-1111-1111-1111-111111111111', 'e3c33333-3333-3333-3333-333333333333', 'Early Bird', 'Discounted general ticket (limited quantity)', 2000, 300, 300, 0, true),
  ('a3b22222-2222-2222-2222-222222222222', 'e3c33333-3333-3333-3333-333333333333', 'Advance Ticket', 'General gate admission pass', 3500, 800, 410, 1, true),

  -- Tiers for Comedy Night
  ('a4a11111-1111-1111-1111-111111111111', 'e4d44444-4444-4444-4444-444444444444', 'General Admission', 'Guaranteed seat in the main gallery', 1500, 600, 350, 0, true),
  ('a4b22222-2222-2222-2222-222222222222', 'e4d44444-4444-4444-4444-444444444444', 'VVIP Table', 'Table of 4 with a complementary bottle of wine', 12000, 50, 30, 1, true),

  -- Tiers for Marathon
  ('a5a11111-1111-1111-1111-111111111111', 'e5e55555-5555-5555-5555-555555555555', 'Athlete Registration', 'Official marathon bib and runner kit', 1000, 1000, 120, 0, true)
on conflict (id) do nothing;
...
insert into orders (id, reference, customer_id, event_id, tier_id, quantity, unit_price, total_amount, status, phone, checked_in, checked_in_at, created_at) values
  ('b1a11111-1111-1111-1111-111111111111', 'ORD-SUMMIT01', 'a1e6b911-37f2-4ef8-82ea-2a9f4c3a590b', 'e1a11111-1111-1111-1111-111111111111', 'a1a11111-1111-1111-1111-111111111111', 2, 3000, 6000, 'confirmed', '0711111111', true, now() - interval '2 days', now() - interval '2 days'),
  ('b1b22222-2222-2222-2222-222222222222', 'ORD-SUMMIT02', 'b2f7c022-4803-5fa9-93fb-3b0a5d4b601c', 'e1a11111-1111-1111-1111-111111111111', 'a1b22222-2222-2222-2222-222222222222', 1, 10000, 10000, 'confirmed', '0722222222', false, null, now() - interval '1 day'),
  ('b2a11111-1111-1111-1111-111111111111', 'ORD-SOLFEST1', 'a1e6b911-37f2-4ef8-82ea-2a9f4c3a590b', 'e2b22222-2222-2222-2222-222222222222', 'a2a11111-1111-1111-1111-111111111111', 4, 2500, 10000, 'confirmed', '0711111111', true, now() - interval '3 hours', now() - interval '4 hours'),
  ('b3a11111-1111-1111-1111-111111111111', 'ORD-BLANKET1', 'b2f7c022-4803-5fa9-93fb-3b0a5d4b601c', 'e3c33333-3333-3333-3333-333333333333', 'a3b22222-2222-2222-2222-222222222222', 1, 3500, 3500, 'pending', '0722222222', false, null, now() - interval '1 hour')
on conflict (id) do nothing;

-- Seed Payments
insert into payments (id, reference, order_id, customer_id, amount, mpesa_code, mpesa_phone, status) values
  ('c1a11111-1111-1111-1111-111111111111', 'TXN-KICC1111', 'b1a11111-1111-1111-1111-111111111111', 'a1e6b911-37f2-4ef8-82ea-2a9f4c3a590b', 6000, 'QWE123RTY4', '0711111111', 'success'),
  ('c1b22222-2222-2222-2222-222222222222', 'TXN-KICC2222', 'b1b22222-2222-2222-2222-222222222222', 'b2f7c022-4803-5fa9-93fb-3b0a5d4b601c', 10000, 'ASD456ZXC7', '0722222222', 'success'),
  ('c2a11111-1111-1111-1111-111111111111', 'TXN-SOLFEST1', 'b2a11111-1111-1111-1111-111111111111', 'a1e6b911-37f2-4ef8-82ea-2a9f4c3a590b', 10000, 'MPESA88888', '0711111111', 'success')
on conflict (id) do nothing;
...
insert into payouts (id, reference, organizer_id, event_id, gross_amount, fee_amount, net_amount, status, mpesa_phone, processed_at) values
  ('d1a11111-1111-1111-1111-111111111111', 'PAY-OUT00001', (select id from users where username = 'dominicoigo8' limit 1), 'e1a11111-1111-1111-1111-111111111111', 16000, 800, 15200, 'completed', '254716411222', now() - interval '12 hours')
on conflict (id) do nothing;
